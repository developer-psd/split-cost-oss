package com.getcollate.expenseSplitter.repository.postgres;
...
import com.getcollate.expenseSplitter.repository.postgres.jpa.TripCurrentSettlementJpaRepository;
import com.getcollate.expenseSplitter.repository.postgres.jpa.TripJpaRepository;
import com.getcollate.expenseSplitter.repository.postgres.jpa.TripTransactionBeneficiaryJpaRepository;
import com.getcollate.expenseSplitter.repository.postgres.jpa.TripTransactionJpaRepository;
import com.getcollate.expenseSplitter.repository.postgres.support.PostgresAggregateMapper;
...
public class PostgresTripTransactionRepository implements TripTransactionReporitory {
    ...
    private List<TripTransactionBeneficiaryEntity> toBeneficiaryEntities(UUID tripId, Transaction transaction) {
        ...
        List<com.getcollate.trip.Participant> beneficiaries = transaction.benefittedBy();

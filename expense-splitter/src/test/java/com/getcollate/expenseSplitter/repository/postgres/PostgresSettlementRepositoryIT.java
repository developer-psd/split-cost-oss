...
class PostgresSettlementRepositoryIT extends AbstractPostgresRepositoryIT {
    ...
    @Autowired
    private com.getcollate.expenseSplitter.repository.postgres.jpa.TripCurrentSettlementJpaRepository settlementJpaRepository;
    ...
    void persistSettlement_shouldRewritePreviousSnapshotNotAppend() {
        ...
        List<com.getcollate.expenseSplitter.repository.postgres.entity.TripCurrentSettlementEntity> rows = settlementJpaRepository.findByIdTripIdOrderByIdSettlementOrderAsc(UUID.fromString(trip.getTripId()));

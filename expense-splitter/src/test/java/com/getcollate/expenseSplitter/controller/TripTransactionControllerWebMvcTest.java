...
import com.getcollate.expenseSplitter.exception.GlobalExceptionHandler;
import com.getcollate.expenseSplitter.exception.GlobalValidationExceptionHandler;
...
class TripTransactionControllerWebMvcTest {
    ...
    void postTransaction_shouldReturnCreatedTransactions() throws Exception {
        Transaction tx = TestFixtures.transaction(
                ...
                3030f,
                "P1",
                com.getcollate.trip.accounts.CATEGORY.FOOD,
                "01/01/2020",
                List.of("P1", "P2")
        );
    ...
    void getTransactions_shouldReturnAllTransactions() throws Exception {
        Transaction tx = TestFixtures.transaction(
                ...
                1000f,
                "P1",
                com.getcollate.trip.accounts.CATEGORY.TRANSPORT,
                "01/01/2020",
                List.of("P1", "P2")
        );
